...
JuzJS = (function() {
  ...
  Node = (function(_super) {
    ...
    Node.prototype.setX = function(new_x) {
      ...
      Node.__super__.setX.call(this, Math.round(new_x));
      _ref = this.outConnections;
      for (id in _ref) {
        obj = _ref[id];
    ...
    Node.prototype.setY = function(new_y) {
      ...
      Node.__super__.setY.call(this, Math.round(new_y));
      _ref = this.outConnections;
      for (id in _ref) {
        obj = _ref[id];
  ...
  PhysicsEngine = (function() {
    ...
    PhysicsEngine.prototype.update = function(nodeList, canvas) {
      var centerizeVector, forceList, gravityVector, node, replusionVector;
      forceList = (function() {
        ...
        for (_i = 0, _len = nodeList.length; _i < _len; _i++) {
          ...
          _results.push(replusionVector.add(gravityVector).add(centerizeVector));
        }
        return _results;
      }).call(this);
      return this.updatePosition(nodeList, forceList);
    };
